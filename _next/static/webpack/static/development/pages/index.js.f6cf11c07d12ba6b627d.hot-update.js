...
var formatData = function formatData(date, data) {
  var datasets = [];
  var pastDates = data.filter(function (d) {
    return d.date < date;
  });
  var upcomingDates = data.filter(function (d) {
    return d.date > date;
  });
...
//# sourceMappingURL=index.js.f6cf11c07d12ba6b627d.hot-update.js.map